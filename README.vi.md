...
**Hệ thống điều hướng type-safe, can thiệp được cho SwiftUI — quản lý stack tập trung, sẵn sàng deep link, Swift 6 native.**

[![Swift 6.0](https://img.shields.io/badge/Swift-6.0-F05138?logo=swift&logoColor=white)](https://swift.org)
[![Platforms](https://img.shields.io/badge/Platforms-iOS%2016%2B%20%7C%20macOS%2013%2B-blue?logo=apple)](#yêu-cầu)
[![SPM](https://img.shields.io/badge/SwiftPM-compatible-brightgreen)](#cài-đặt)
[![License: MIT](https://img.shields.io/badge/License-MIT-lightgrey)](LICENSE)

> [English](README.md) | Tiếng Việt

Quản lý stack tập trung, xử lý sheet/cover toàn cục, API hỗ trợ sẵn deep link, và chuỗi interceptor hai giai đoạn cho auth guard, analytics, khóa điều hướng.
